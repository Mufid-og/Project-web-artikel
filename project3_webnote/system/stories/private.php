...
$id = $_SESSION['id'];
$sql = "SELECT * from content inner join user on content.user_id = user.id where content.user_id = $id and content.public = FALSE and content.delete_at is null";
...
<body>
    ...
    <div class="status">
        <div class="content">
            <a href="private.php" style="border-bottom: 1px solid black; padding-bottom:1rem;">Private</a>
    ...
    <div class="contentt">
        <?php foreach ($result as $row) { ?>
            ...
            <div class="crud">
                <form action="../crud/update/edit.php" method="POST">
                ...
                <form action="../crud/delete/softDelete.php" method="POST" id="drop">
